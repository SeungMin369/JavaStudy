...
public class B03_Operator03 {
	...
	public static void main(String[] args) {
		...
		num = 30;
		System.out.println(num++);// num이 출력되고나서 ++이 더해진다
		System.out.println(num);// 1이 더해졌다
		//++, --를 앞에 붙이면 해당 줄의 명령을 실행하기 전에 값을 변화시킨다
		num = 30;
		System.out.println(++num);// num이 출력되기전에 ++이 더해졋다 
