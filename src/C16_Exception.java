...
public class C16_Exception {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("말도 안되는 계산을 하셨네요. 다음부터는 그러지마세요. 디지기싫으면");
			
		} catch (ArrayIndexOutOfBoundsException e) {
			System.out.println("최대 인덱스의 길이보다 1작습니다!!");
		} catch (InputMismatchException e) {
			System.out.println("반드시 10진수 정수만 입력하라고 했잖아");
		} finally {
			System.out.println(" /)/)");
			System.out.println("( ..)");
			System.out.println("( >♡)");
